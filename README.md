# UI Foundry List Studio

Standalone visual List generator built with Next.js, React, and TypeScript.

Standalone List component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building List UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained List generator
...
The editor is focused on controls that are native to List and useful in real product work:
- item count, leading/trailing content, avatar/icon, metadata, description, and action slots
- density, divider, hover, selected, disabled, and focus states
- ordered, unordered, navigation, checklist, and media-list intent
- semantic list/nav labeling and keyboard-safe actions
- React export for list structure

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as List.
...
This repo is intended to publish as Abid-Al-Hossain/UI_list.
